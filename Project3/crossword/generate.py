...
class CrosswordCreator():
        ...
        for var in self.crossword.variables:
            ...
            for word in self.domains[var]:
                if len(word)!=var.length:
                    word_to_be_remove.append(word)

            for word in word_to_be_remove:
    ...
    def order_domain_values(self, var, assignment):
        ...
        for word in self.domains[var]:
            ...
            value_constraints.append((word,eliminated_count))

        value_constraints.sort(key=lambda x:x[1])

        return [word for word,count in value_constraints]
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in unassigned_vars:
            remaining_count=len(self.domains[var])
            if remaining_count<min_remaining:
                min_remaining=remaining_count
                mrv_vars=[var]

            elif remaining_count==min_remaining:
                mrv_vars.append(var)
